...
var client_references_default = {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-B936YUVk.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"b6a451a68c84": async () => {
		const m = await import("./assets/providers-B_AMbOc7.js");
...
//#endregion
export { useRouter as a, __toESM as c, app_ssr_entry_default as default, handleSsr, usePathname as i, require_jsx_runtime as n, require_react as o, getLayoutSegmentContext as r, __commonJSMin as s, require_react_dom as t };
