globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/tooltip-BGrmrlpc.js","assets/page-BH8z-Y5C.js","assets/graph-canvas-BPp08H-b.js","assets/providers-BggbZwvw.js","assets/layout-segment-context-C3H7MHl1.js"];
...
function getDraftSecret() {
	return "5da2e81c-a83d-4686-ba44-5c980e8b507c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c17dd085-5db0-4638-9150-5bfd408525c5";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c17dd085-5db0-4638-9150-5bfd408525c5") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c17dd085-5db0-4638-9150-5bfd408525c5",
		rootBoundaryId
	});
}
/**
