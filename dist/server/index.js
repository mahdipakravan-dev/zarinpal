globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/tooltip-wjM-F9Tr.js","assets/page-BOL8nh3z.js","assets/providers-CDro0EgQ.js","assets/layout-segment-context-xm5WQLde.js"];
...
function getDraftSecret() {
	return "1b51cddc-f0a4-40ae-a085-9de9bfdc0e4d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "89d57065-33fd-49e0-96d3-4e32492b9d60";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "89d57065-33fd-49e0-96d3-4e32492b9d60") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "89d57065-33fd-49e0-96d3-4e32492b9d60",
		rootBoundaryId
	});
}
/**
