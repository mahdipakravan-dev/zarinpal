...
export const WebPreviewConsole = ({
  ...
  return (
    <Collapsible
      ...
      {...props}
    >
      <CollapsibleTrigger render={<Button className="flex w-full items-center justify-between p-4 text-start font-medium hover:bg-muted/50" variant="ghost" />}>Console
                    <ChevronDownIcon
                      className={cn(
